...
export default function HelpAttaching(): JSX.Element {
    return (
        <div>
            ...
            <p>
                <FormattedMessage
                    ...
                    defaultMessage='Flipchat has a built in file previewer that is used to view media, download files and share public links. Click the thumbnail of an attached file to open it in the file previewer.'
                />
            </p>
            ...
            <p>
                <FormattedMarkdownMessage
                    ...
                    defaultMessage='Public links allow you to share file attachments with people outside your Flipchat team. Open the file previewer by clicking on the thumbnail of an attachment, then click **Get Public Link**. This opens a dialog box with a link to copy. When the link is shared and opened by another user, the file will automatically download.'
                />
            </p>
            <p>
                <FormattedMarkdownMessage
            ...
            <p>
                <FormattedMessage
                    ...
                    defaultMessage='If you are trying to preview a media type that is not supported, the file previewer will open a standard media attachment icon. Supported media formats depend heavily on your browser and operating system, but the following formats are supported by Flipchat on most browsers:'
                />
            </p>
            <ul>
                <li>
            ...
            <p>
                <FormattedMessage
                    ...
                    defaultMessage='Flipchat supports a maximum of five attached files per post, each with a maximum file size of 50Mb.'
                />
            </p>
            <p className='links'>
                <FormattedMessage
