            ...
            errorMessage = (
                <div>
                    <FormattedMessage
                        ...
                        defaultMessage='Flipchat was unable to load because a setting in your browser prevents the use of its local storage features. To allow Flipchat to load, try the following actions:'
                    />
                    <ul>
                        <li>
                            <FormattedMessage
                ...
                <div>
                    ...
                    <p>
                        <FormattedMessage
                            ...
                            defaultMessage='For {link} make sure the administrator of your Microsoft organization has enabled the Flipchat app.'
                            values={{
                                link: (
                                    <ErrorLink
            ...
            errorMessage = (
                <p>
                    <FormattedMessage
                        ...
                        defaultMessage='You must authorize Flipchat to log in with {service}.'
                        values={{
                            service,
                        }}
                    />
